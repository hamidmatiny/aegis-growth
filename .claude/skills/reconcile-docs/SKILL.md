...
7. **Guidelines ↔ behavior** — guidelines don't contradict what the skills actually do. In particular, verify no skill has drifted toward business interpretation, forecasting, or use of a write/admin credential — those are hard boundaries in CLAUDE.md.
...
```
## Doc Reconciliation: aegis-growth
